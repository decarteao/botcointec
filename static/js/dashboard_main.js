...
const updateCharts = () => {
  ...
  mainChart.options.scales.x.grid.borderColor = coreui.Utils.getStyle('--cui-border-color-translucent');
  ...
  mainChart.options.scales.y.grid.borderColor = coreui.Utils.getStyle('--cui-border-color-translucent');
